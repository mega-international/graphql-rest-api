...
namespace Hopex.Model.MetaModel
{
    internal class HopexMetaModel : IHopexMetaModel
    {
        ...
        public IClassDescription FindClassDescriptionById(MegaId metaClassId)
        {
            var normalizedId = Utils.NormalizeHopexId(metaClassId.ToString());
            _classesById.TryGetValue(normalizedId, out var cd);
            return cd;
        }
