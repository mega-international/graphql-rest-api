...
namespace Hopex.Model.Abstractions
{
    ...
    public interface IPivotSchemaConvertor
    {
        ...
        /// <returns></returns>
        Task<ValidationContext> ValidateAsync(IHopexMetaModelManager schemaManager, PivotSchema.Models.PivotSchema pivot);
        /// <summary>
        ...
        Task<IHopexMetaModel> ConvertAsync(IHopexMetaModelManager schemaManager, PivotSchema.Models.PivotSchema schema);
    }
}
