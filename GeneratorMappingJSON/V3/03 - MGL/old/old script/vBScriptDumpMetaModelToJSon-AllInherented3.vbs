...
' Set oMetaModel = getObjectFromId("~igEKBLUkSjkG[00 - Webservice extract GDPR]")

' sPath= "C:\temp\Incident.json"
' Set oMetaModel = getObjectFromId("~NfEKpIDmSDpH[00 - Webservice extract Incident]")

 sPath= "C:\temp\Audit.json"
 Set oMetaModel = getObjectFromId("~bcLTwMt5THDO[00 - Webservice extract Audit]")
...
File.writeLine(Chr(34) & "metaclass" & Chr(34) &":[") 'open entitites
...
File.writeLine(Chr(9) & "]")  ' entities
  ...
  ' --- commonProperties ---
File.writeLine(Chr(34) & "commonProperties" & Chr(34) &":[") 'open entitites
...
function commonProperties(File)
...
function getMetaAssociationEnd(oMetaModel, oMetaClass,File)
  ...
  for i = 1 to icount 
    ...
    if (otest.getId() <> 0)  then
      ...
      ' we treat in a different way the MEA for person assignment
      if (oMEA.sameID(oRoot.getObjectFromId("~gCr81RIpErMH[Person Assignment]").getId())) then
        dim sUseless1
        sUseless1 = manageObjectassignment(oMetaModel, oMetaClass, oMEA,oMetaClassTarget)
...
function manageObjectassignment(oMetaModel, oMetaClass, oMEA,oMetaClassTarget)
  ...
  ' only if the metaclass is in the diagram we navigate	
 
   if (otest.getId() <> 0)  then

Dim oColAssignableRole 
Set  oColAssignableRole = oMetaClass.getCollection("~I2mxh)(9F1p8[Assignable Role]")

Dim oassignableRole 

for each oassignableRole in oColAssignableRole 

  Dim sBusinessRoleName 
  sBusinessRoleName = GetTechnicalName(oassignableRole.getProp("~Z20000000D60[Short Name]"))
          ...
          Dim sMetaMultiplicity
       		Dim technincalNameMEAFilter 
      		Dim technincalNameMetaClassFilter
      		Dim targetMetaClassIDFilter
        	Dim IdAbsMEAFilter
          Dim sMetaMultiplicityFilter
					Dim pathToTarget
        ...
        Dim oMEA3
				Dim oMetaClassTarget3  

        	oMEA3 =oRoot.getObjectFromId("~M2000000Ce80[Business Role]")
          oMetaClassTarget3 = oRoot.getObjectFromId("~230000000A40[Business Role]")

          IdAbsMEAFilter= oMEA3.getProp("~310000000D00[Absolute Identifier]")
          technincalNameMetaClassFilter= GetTechnicalName(oMetaClassTarget3.getProp("~Z20000000D60[Short Name]"))  
        	technincalNameMEAFilter = GetTechnicalName(oMEA3.getProp("~Z20000000D60[Short Name]"))   
        	targetMetaClassIDFilter= oMetaClassTarget3.getProp("~310000000D00[Absolute Identifier]")
          sMetaMultiplicityFilter= oassignableRole.getProp("~TvgBDhpLGPPF[Business Role Multiplicity]") 

          Dim sObjectShortName 
          Dim sObjectID 
              			
          sObjectShortName =oassignableRole.getProp("~Z20000000D60[Short Name]")
          sObjectID =oassignableRole.getProp("~310000000D00[Absolute Identifier]")
          ...
          "" &  Chr(10) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(34) & "conditions" &  Chr(34) & ": {" &_
          "" &  Chr(10) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(34) & "maeFilters" & Chr(34) & ": [" &_
          "" &  Chr(10) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & "{" &_
          "" &  Chr(10) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(34) & "maeName" &  Chr(34) & ":" &  Chr(34) & technincalNameMEAFilter &  Chr(34) & "," &_
          "" &  Chr(10) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(34) & "maeID" &  Chr(34) & ":" &  Chr(34) & IdAbsMEAFilter  &  Chr(34) & "," &_
          "" &  Chr(10) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(34) & "metaClassName" &  Chr(34) & ":" &  Chr(34) & technincalNameMetaClassFilter &  Chr(34) & "," &_
          "" &  Chr(10) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(34) & "metaClassID" &  Chr(34) & ":" &  Chr(34) & targetMetaClassIDFilter  &  Chr(34) & "," &_
          "" &  Chr(10) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(34) & "multiplicity" &  Chr(34) & ":" &  Chr(34) & sMetaMultiplicityFilter &  Chr(34) & "" &_
          "" &  Chr(10) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(34) & "limitingObjects" &  Chr(34) & ": [" &_
          "" &  Chr(10) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & "{" &_
          "" &  Chr(10) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(34) & "objectShortName" &  Chr(34) & ":" &  Chr(34) & sObjectShortName &  Chr(34) & "," &_
          "" &  Chr(10) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(34) & "objectID" &  Chr(34) & ":" &  Chr(34) & sObjectID &  Chr(34) & "" &_
          "" &  Chr(10) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & "}" &_
          "" &  Chr(10) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & "]" &_
          "" &  Chr(10) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9)& Chr(9) & "}" &_
          "" &  Chr(10) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & "]" &_
          "" &  Chr(10) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & "}" &_
          "" &  Chr(10) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & "}" &_
          ","
          
        Dim oMEA2
				Dim oMetaClassTarget2  

        	oMEA2 =oRoot.getObjectFromId("~L2000000Ca80[Assigned Person]")
          oMetaClassTarget2 = oRoot.getObjectFromId("~T20000000s10[Person <System>]")

        
          IdAbsMEA = oMEA2.getProp("~310000000D00[Absolute Identifier]")
          technincalNameMetaClass = GetTechnicalName(oMetaClassTarget2.getProp("~Z20000000D60[Short Name]"))  
        	technincalNameMEA = GetTechnicalName(oMEA2.getProp("~Z20000000D60[Short Name]"))   
        	targetMetaClassID= oMetaClassTarget2.getProp("~310000000D00[Absolute Identifier]")
          sMetaMultiplicity = oassignableRole.getProp("~TvgBDhpLGPPF[Business Role Multiplicity]") 

              pathToTarget = pathToTarget &_
          "" & Chr(10) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & "{" &_
          "" &  Chr(10) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(34) & "maeName" &  Chr(34) & ":" &  Chr(34) & technincalNameMEA &  Chr(34) & "," &_
          "" &  Chr(10) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(34) & "maeID" &  Chr(34) & ":" &  Chr(34) & IdAbsMEA  &  Chr(34) & "," &_
          "" &  Chr(10) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(34) & "metaClassName" &  Chr(34) & ":" &  Chr(34) & technincalNameMetaClass &  Chr(34) & "," &_
          ...
          File.writeLine(Chr(9) & Chr(9) & Chr(9) & Chr(9) & "{")
    			File.writeLine(Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(9) & Chr(34) & "name" & Chr(34) & ":" & Chr(34) & sBusinessRoleName & Chr(34) & ",")
