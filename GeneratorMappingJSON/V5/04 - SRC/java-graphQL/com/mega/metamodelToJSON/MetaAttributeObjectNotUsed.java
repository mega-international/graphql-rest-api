...
public class MetaAttributeObjectNotUsed extends CommonAttributes {
	...
	public MetaAttributeObjectNotUsed(MegaRoot megaRoot, MegaObject oMetamodel, MegaObject oStartingMetaClass, MetaAttribute metaAttribute, HashMap<String,String> overrideNameList) {
