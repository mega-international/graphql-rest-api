...
public class OpenHOPEX {
	...
	public OpenHOPEX(String sAdministrator, String sPassword, String openMode) throws Exception {
		...
		if (megaEnvironment == null) {
			throw new Exception("MEGA HOPEX Environment not Found. Please verify the path provided.");
		}
	...
	//	megaEnvironment.is
		...
		//System.out.println(megaRoot.currentEnvironment().getMegaUserPath());
		//System.out.println(megaRoot.currentEnvironment().site().getUserPath());
