...
public class Generator {
	...
	public static void main(String[] args) throws Exception{
		...
		Generator.logger.config("Is Archimate            = "+Arguments.getIsArchimate());
		Generator.logger.config("Open Mode               = "+Arguments.getOpenEXmode());
	...
	private static void generateMetaModel(String metaModelName, String metaModelidAbs, String login, String password, String profile, String filePath, String fileNameOverride, String latestGeneration) throws Exception {
		...
		if (Arguments.getOpenEXmode() < 2) {
			// V3 or old connexion mode
			openMode =  "-Role:" + profile + " -TranType:Micro -OpenMode:R";	
			
		} else {	
			// V3-V4-V5 new connexion mode
			openMode = "#Login=" + login + ";Password=" + password + ";Profile=" + profile + ";TranType:Micro;OpenMode:R";		
		}

		Generator.logger.finest("openMode = " + openMode);	
		
		OpenHOPEX openHOPEX = new OpenHOPEX(login, password, openMode);			
		
		// connexion string for V3-V4
		//                login, password, "-Role:" + profile + " -TranType:Micro -OpenMode:R"
		// connexion string for V5
		//    for admin system               #Login=" & hopexuserlogin & ";TranType=Private;TranType=Micro;OpenMode=W;SessionMode=SS;Profile=HOPEX Administrator;SystemMode=Y
		//    for classic user              #Login=" & hopexuserlogin & ";Password=" & hopexuserpassword & ";Profile=HOPEX Administrator;TranType:Micro;OpenMode:W
		
		//#Login=" & login & ";Password=" & password & ";Profile= & profile &;TranType:Micro;OpenMode:R
