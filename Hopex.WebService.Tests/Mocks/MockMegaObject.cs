...
namespace Hopex.WebService.Tests.Mocks
{
    ...
    public class MockMegaObject : MockMegaItem, IMegaObject
    {
        ...
        public string MegaField => $"~{Id}[MockMegaObject name]";

        public string MegaUnnamedField => $"~{Id}[]";
        ...
        public MockMegaObject(MegaId id, MegaId classId = null)
        {
            ...
            _properties["~310000000D00[Absolute Identifier]"] = new MegaPropertyWithFormat(id);
        }
