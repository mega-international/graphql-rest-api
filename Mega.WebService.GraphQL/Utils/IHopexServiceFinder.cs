...
namespace Mega.WebService.GraphQL.Utils
{
    ...
    {
        string FindSession(string sspUrl, string securityKey, string environment, string dataLanguage, string guiLanguage, string profile, string personId, bool useHopexApiMwas = false);
    ...
    {
        public string FindSession(string sspUrl, string securityKey, string environment, string dataLanguage, string guiLanguage, string profile, string personId, bool useHopexApiMwas = false)
        {
            return HopexService.FindSession(sspUrl, securityKey, environment, dataLanguage, guiLanguage, profile, personId, useHopexApiMwas);
        }
