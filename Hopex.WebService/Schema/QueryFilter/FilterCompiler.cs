...
using Hopex.Modules.GraphQL.Schema.QueryFilter.Nodes;
using System;
...
namespace Hopex.Modules.GraphQL.Schema.Filters
{
    class FilterTree
    {
        ...
        public FilterTree(IDictionary<string, object> filter,
            GraphQLClassDescription graphQlClass,
            IModelElement source = null,
            GraphQLRelationshipDescription graphQlRelationship = null)
        {
            _treeRoot = new FilterNode(graphQlRelationship, graphQlClass, filter, Logical.AND, source, graphQlRelationship);
        }
    ...
    {
        private readonly IMegaRoot _root;
        private readonly StringBuilder _sb = new StringBuilder();
        private GraphQLClassDescription _graphQlClass;
        ...
        public FilterCompiler(IMegaRoot root, GraphQLClassDescription graphQlClass, GraphQLRelationshipDescription graphQlRelationship, IModelElement source)
        {
            _root = root;
        ...
        public string CreateHopexQuery(Dictionary<string, object> filter, IMegaObject language)
        {
            ...
            var tree = new FilterTree(filter, _graphQlClass, _sourceElement, _graphQlRelationship);
            var query = tree.GenerateQueryConditions();
            return query;
        }
        ...
        //{
        //    var (graphPropName, op) = GetOperator(elem.Key);
        //    if(op.Pattern == "rel")
        //    {
        //        if(op.Name == "count")
        //        {
        //            ApplyHavingCountFilter(elem, graphPropName);
        //            return;
        //        }
        //        var savedClassDescription = _graphQlClass;
        //        try
        //        {
        //            GenerateFilterRelationshipPrefix(graphPropName, out _itemClassDescription);
        ...
        //        finally
        //        {
        //            _graphQlClass = savedClassDescription;
        //        }
        //    }
        //    else
        //    {
        //        IRelationshipDescription reversedRelationship = null;
        //        var prop = _graphQlClass.Properties.FirstOrDefault(p => p.Name.Equals(graphPropName))?.MetaAttribute;
        ...
        //                else
        //                {
        //                    var classDescription = _root.GetClassDescription(_itemClassDescription.Id);
        ...
        //        {
        //            throw new ExecutionError($"Number of items in array field [{elem.Key}] should not exceed {_maxItemsInArray}");
        //        }
        //    }
        //}
